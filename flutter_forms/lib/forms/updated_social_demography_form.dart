...
class _SocialDemoFormBody extends State<SocialDemoFormBody> {
  ...
  List<String> dropListReligion = [
    "Hindu", "Jain", "Sikh", "Buddhism", "Parsi", "Muslim", "Christian", "Other"];

  //Variables for Scoil Economic Status
  String socialEconomicStatus = null;
  List<DropdownMenuItem<String>> socialEconomicList = [];
  List<String> dropListSocialEconomicStatus = ["Antyoday","Below Poverty Line","Above Poverty Line","Don't Know"];

  //Variables for Family Income
  String familyIncome = null;
  List<DropdownMenuItem<String>> familyIncomeList = [];
  List<String> dropListFamilyIncome = ["Less than Rs. 1.2 lakh ","Rs. 1.2 lakh to Rs. 2.5 lakh","Rs. 2.5 lakh to Rs. 5 lakh","More than Rs. 5 lakh","Don't want to disclose"];

  //Variables of Birth Interval
  String birthInterval;
  List<DropdownMenuItem<String>> birthIntervalList = [];
  List<String> dropListBirthInterval = ["< 12 Months","12-24 Months",">24 months"];
  ...
  List<String> dropListPlaceOfPreviousDelivery = ["Primary Health Center","Community Health Center","District Hospital","Private Maternity Home",
  "Private Hospital","Home","In Transit","Other"];
  ...
  initState(){
    super.initState();
    purposeOfVisitList = dropListPurposeOfVisit.map((val)=> new DropdownMenuItem(child: new Text(val),value: val,)).toList();
    residentialLocalityList = dropListResidentialLocality.map((val)=> new DropdownMenuItem(child: new Text(val),value: val,)).toList();
    ...
    socialEconomicList = dropListSocialEconomicStatus.map((val)=> new DropdownMenuItem(child: new Text(val),value: val,)).toList();
    familyIncomeList = dropListFamilyIncome.map((val)=> new DropdownMenuItem(child: new Text(val),value: val,)).toList();
    birthIntervalList = dropListBirthInterval.map((val)=> new DropdownMenuItem(child: new Text(val),value: val,)).toList();
    highRiskPregnancyList = dropListHighRiskPregnancy.map((val)=> new DropdownMenuItem(child: new Text(val),value: val,)).toList();
    typeOfDeliveryList = dropListTypeOfDelivery.map((val)=> new DropdownMenuItem(child: new Text(val),value: val,)).toList();
    placeOfPreviousDeliveryList = dropListPlaceOfPreviousDelivery.map((val)=> new DropdownMenuItem(child: new Text(val),value: val,)).toList();
    previousChildSexList = dropListPreviousChildSex.map((val)=> new DropdownMenuItem(child: new Text(val),value: val,)).toList();
  }
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: purposeOfVisit == null? Colors.red : Colors.grey,
                    )),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.all(Radius.circular(4.0)),
                    border: Border.all(
                      color: residentialLocality == null? Colors.red : Colors.grey,
                    )),
                child: DropdownButtonHideUnderline(
                    child: DropdownButton(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.all(Radius.circular(4.0)),
                    border: Border.all(
                      color: socialEconomicStatus == null? Colors.red : Colors.grey,
                    )),
                child: DropdownButtonHideUnderline(
                    child: DropdownButton(
              ...
              Container(
                ...
                child: DateTimePickerFormField(
                  ...
                  decoration: InputDecoration(
                      labelText: 'Expected Delivery Date', hasFloatingPlaceholder: false),
                  onChanged: (dt) => setState(() => expectedDeliveryDate = dt),
              ...
              garvida.text.toString()!=""?(int.parse(garvida.text.toString())>1)?Container(
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(),
                        labelText: "Birth Order for Current Pregnancy",
                        errorBorder: const OutlineInputBorder(
                          borderSide: const BorderSide(color: Colors.red, width: 0.0),
                        ),
                      ),
                      validator: (String number){
                        if(number!="") {
                          if (number.length > 1 || int.parse(number) !=
                              int.parse(numberOfLiveBirths.text.toString()) +
                                  1) {
                            validateForm.add(true);
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.all(Radius.circular(4.0)),
                          border: Border.all(
                            color: birthInterval == null? Colors.red : Colors.grey,
                          )),
                      child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.all(Radius.circular(4.0)),
                          border: Border.all(
                            color: highRiskPregnancy == null? Colors.red : Colors.grey,
                          )),
                      child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                              hint: Text("Select Birth Interval"),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.all(Radius.circular(4.0)),
                          border: Border.all(
                            color: typeOfDelivery == null? Colors.red : Colors.grey,
                          )),
                      child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.all(Radius.circular(4.0)),
                          border: Border.all(
                            color: placeOfPreviousDelivery == null? Colors.red : Colors.grey,
                          )),
                      child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                              hint: Text("Select One Option"),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.all(Radius.circular(4.0)),
                          border: Border.all(
                            color: previousChildSex == null? Colors.red : Colors.grey,
                          )),
                      child: DropdownButtonHideUnderline(
                          child: DropdownButton(
